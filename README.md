...
여러 Agent CLI와 외부 채널을 하나의 로컬 데몬으로 Agent Mesh Hub에 연결합니다. 최종 사용자는 Bun·Node.js·npm 없이 standalone `agent-mesh` 바이너리 하나를 설치하고, TUI에서 Hub·lane·runtime·channel을 설정할 수 있습니다.
